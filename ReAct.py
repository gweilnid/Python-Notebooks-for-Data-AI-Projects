...
def substract(a: int, b: int):
    """This is an substraction function that substracts 2 numbers"""

    return a - b

@tool
def multiply(a: int, b: int):
    """This is an multiply function that multiplies 2 numbers"""
...
inputs = {"messages" : [("user", "Add 3 + 4, do  5 * 95 also I need to know 33 / 11 and one more 21 + 21, tell me a joke :)")]}
